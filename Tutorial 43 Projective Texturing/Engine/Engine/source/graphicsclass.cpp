...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_ProjectionTexture->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/dx2.tga");
	if(!result)
	{
	...
	m_ViewPoint->SetPosition(2.0f, 5.0f, -10.0f);
	m_ViewPoint->SetLookAt(0.0f, 0.0f, 0.0f);
	m_ViewPoint->SetProjectionParameters((3.141592654f / 2.0f), 1.0f, 0.1f, 100.0f);
